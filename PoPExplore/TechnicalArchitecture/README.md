...
| GET/transaction/from/{address} | result: [list transaction] <img width=100% src="img/Code1.png"> | List transactions sent by a wallet.. |
| GET/transaction/to/{address} | result: [list transactions] <img width=100% src="img/Code2.png"> | List transactions recivied by a wallet. |
| GET/transaction/tx/{hash} | result: [transaction object] <img width=100% src="img/Code3.png"> | List transaction information |
| GET/transaction/latest-transactions/ | result: [list transaction] <img width=100% src="img/Code4.png"> | List of 5 lastest transactions from network. |
| GET/block/latest-blocks/ | result: [list block object] <img width=100% src="img/Code5.png"> | List of 5 lastest blocks from network. |
| GET/block/block-number/{height} | result: block object <img width=100% src="img/Code6.png"> | Block information by block number. |
| GET/block/block-hash/{hash} | result: block object <img width=100% src="img/Code7.png"> | Block information by block hash. |
